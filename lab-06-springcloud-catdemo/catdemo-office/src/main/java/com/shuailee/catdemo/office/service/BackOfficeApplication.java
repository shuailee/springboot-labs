package com.shuailee.catdemo.office.service;
...
import com.shuailee.cathelper.CatRestInterceptor;
...
public class BackOfficeApplication {
	...
	@Value("${service3.address:localhost:7083}") String serviceAddress3;
	//@Value("${service4.address:localhost:7084}") String serviceAddress4;
	...
	public String service2MethodInController() throws InterruptedException {
		...
		return String.format("Hello from Acme Financial's Backend service. Calling Acme Financial's Account Service [%s] and then Customer Service [%s]", service3, service3);
	}
